...
def download_chapters(json_data, outdir, scraper):

    """
    Downloads all the chapters given in json_data of the format
    ...
    for chapter in json_data:
        images = comicV2.get_img_urls(chapter['link'], scraper)
